...
class TimePatternSerializerTest {
    @Test fun absoluteTimes() {
        val input = "2019-01-02T03:04:05"
        val result = TimePatternSerializer.fromJson(input)
        val bijectiveResult = TimePatternSerializer.toJson(result)
    ...
    @Test(expected = IllegalArgumentException::class) fun unknownFormat() {
        val input = "123"
        TimePatternSerializer.fromJson(input)
    }
}
